    ...
    .then(items => {
      ...
      items.forEach(item => {
        ...
        <div class="col-2 d-flex justify-content-center">
          <img src="/img/${item.asset_image}" class="img-fluid rounded" style="width: 60px; height: 100px; object-fit: cover;" alt="${item.asset_name}">
        </div>
        ...
        <div class="col-1 text-center mx-1">ID: ${item.approve_by_id}</div>
        <div class="col-1 text-center mx-1">ID: ${item.handover_by_id}</div>
